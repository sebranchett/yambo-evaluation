...
```
> [!NOTE]
> The file `yambo-5.1.2/config/setup`, that is generated by config-script.sh, contains extra line endings `\n\n` in 2 places around the `hdf5` library. These must be removed by hand before `make` will run.
